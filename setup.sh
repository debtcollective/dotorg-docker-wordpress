...
docker exec dotorg-docker-wordpress_wordpress_1 chown www-data:www-data /var/www/ 
...
docker exec --user www-data -w /var/www/html/ dotorg-docker-wordpress_wordpress_1 composer install
