...
docker exec --user www-data -w /var/www/html/ dotorg-docker_wordpress_1 composer config --auth github-oauth.github.com "$GITHUB_TOKEN"
docker exec --user www-data -w /var/www/html/ dotorg-docker_wordpress_1 composer update
docker exec --user www-data -w /var/www/html/wp-content/themes/dotorg-theme dotorg-docker_wordpress_1 composer update
