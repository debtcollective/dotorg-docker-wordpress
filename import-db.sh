...
docker exec --user root -w /var/www/html/ dotorg-docker_wordpress_1 bash -c "wp theme activate dotorg-theme"
docker exec --user root -w /var/www/html/ dotorg-docker_wordpress_1 bash -c "wp plugin activate dotorg-site-functionality"